...
| Name                                                      | Flags                                                                                                                                                 | Cost | Hardness | Rad. | Flam. | Expl.| Color   |
|-----------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|:----:|:--------:|:----:|:-----:|:----:|---------|
| **[CP]** Copper <img id="spr" src="../img/cp.png">        | <img id="spr" src="../img/block.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/launch.png"><img id="spr" src="../img/drill.png"> | .5   | 1        |      |       |      | #d99d73<!--cp-->
| **[LE]** Lead <img id="spr" src="../img/le.png">          | <img id="spr" src="../img/block.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/launch.png"><img id="spr" src="../img/drill.png"> | .7   | 1        |      |       |      | #8c7fa9<!--le-->
| **[MG]** Metaglass <img id="spr" src="../img/mg.png">     | <img id="spr" src="../img/block.png"><img id="spr" src="../img/factory.png"><img id="spr" src="../img/launch.png">                                    | 1.5  |          |      |       |      | #ebeef5<!--mg-->
| **[GR]** Graphite <img id="spr" src="../img/gr.png">      | <img id="spr" src="../img/block.png"><img id="spr" src="../img/factory.png"><img id="spr" src="../img/launch.png">                                    | 1    |          |      |       |      | #b2c6d2<!--gr-->
| **[SA]** Sand <img id="spr" src="../img/sa.png">          | <img id="spr" src="../img/blank.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/drill.png">  |      |          |      |       |      | #e3d39e<!--sa-->
| **[CO]** Coal <img id="spr" src="../img/co.png">          | <img id="spr" src="../img/blank.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/drill.png">  |      | 2        |      | 1     | .4   | #272727<!--co-->
| **[TI]** Titanium <img id="spr" src="../img/ti.png">      | <img id="spr" src="../img/block.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/launch.png"><img id="spr" src="../img/drill.png"> | 1    | 3        |      |       |      | #8da1e3<!--ti-->
| **[TH]** Thorium <img id="spr" src="../img/th.png">       | <img id="spr" src="../img/block.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/launch.png"><img id="spr" src="../img/drill.png"> | 1.1  | 4        | 1    |       | .2   | #f9a3c7<!--th-->
| **[SC]** Scrap <img id="spr" src="../img/sc.png">         | <img id="spr" src="../img/blank.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/drill.png">  |      |          |      |       |      | #777777<!--sc-->
| **[SI]** Silicon <img id="spr" src="../img/si.png">       | <img id="spr" src="../img/block.png"><img id="spr" src="../img/factory.png"><img id="spr" src="../img/launch.png">                                    | .8   |          |      |       |      | #53565c<!--si-->
| **[PL]** Plastanium <img id="spr" src="../img/pl.png">    | <img id="spr" src="../img/block.png"><img id="spr" src="../img/factory.png"><img id="spr" src="../img/launch.png">                                    | 1.3  |          |      | .1    | .2   | #cbd97f<!--pl-->
| **[PF]** Phase Fabric <img id="spr" src="../img/pf.png">  | <img id="spr" src="../img/block.png"><img id="spr" src="../img/factory.png"><img id="spr" src="../img/launch.png">                                    | 1.3  |          | .6   |       |      | #f4ba6e<!--pf-->
| **[SU]** Surge Alloy <img id="spr" src="../img/su.png">   | <img id="spr" src="../img/block.png"><img id="spr" src="../img/factory.png"><img id="spr" src="../img/launch.png">                                    |      |          |      |       |      | #f3e979<!--sa-->
| **[SP]** Spore Pods <img id="spr" src="../img/sp.png">    | <img id="spr" src="../img/blank.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/blank.png"><img id="spr" src="../img/drill.png">  |      |          |      | 1.05  |      | #7457ce<!--sp-->
| **[BC]** Blast Compound <img id="spr" src="../img/bc.png">| <img id="spr" src="../img/blank.png"><img id="spr" src="../img/factory.png">                                                                          |      |          |      | .4    | 1.2  | #ff795e<!--bc-->
| **[PY]** Pyratite <img id="spr" src="../img/py.png">      | <img id="spr" src="../img/blank.png"><img id="spr" src="../img/factory.png">                                                                          |      |          |      | 1.4   | .4   | #ffaa5f<!--py-->
